...
@EchelonWidget({
  ...
  styles: [`
    ...
    .search { flex: 1; max-width: 260px; padding: 6px 10px; background: var(--panel-alt, #1f2937); border: 1px solid var(--border, #374151); color: var(--fg, #e5e7eb); border-radius: 4px; font-size: 12px; }
    ...
    .form-item { background: var(--panel, #0f172a); border: 1px solid var(--border, #374151); border-left: 3px solid var(--border, #374151); border-radius: 3px; padding: 8px 10px; cursor: pointer; text-align: left; display: flex; flex-direction: column; gap: 2px; color: var(--fg, #e5e7eb); font-family: inherit; }
    ...
    .badge-embedded { font-size: 8px; color: var(--muted, #9ca3af); background: #1f2937; padding: 1px 5px; border-radius: 2px; text-transform: uppercase; }
    .form-line-2 { font-size: 10px; color: var(--muted, #6b7280); }
    .form-line-3 { font-size: 9px; color: var(--muted, #4b5563); }

    .detail { padding: 16px; overflow-y: auto; display: flex; flex-direction: column; gap: 12px; min-width: 0; }
    .detail-header { display: flex; align-items: flex-start; justify-content: space-between; padding-bottom: 10px; border-bottom: 1px solid var(--border, #1f2937); flex-shrink: 0; }
    ...
    .readonly-info { padding: 16px; background: #1f2937; border: 1px solid var(--border, #374151); border-radius: 4px; font-size: 12px; color: var(--muted, #9ca3af); line-height: 1.5; }

    .contract { display: grid; grid-template-columns: 1fr 1fr; gap: 10px; }
    .contract-section { background: var(--panel-alt, #111827); border: 1px solid var(--border, #1f2937); border-radius: 4px; padding: 10px; }
    .contract-header { display: flex; align-items: center; gap: 6px; font-size: 10px; text-transform: uppercase; letter-spacing: 0.3px; color: var(--muted, #9ca3af); font-weight: 600; margin-bottom: 6px; }
    ...
    .col-fields, .col-preview, .col-details { background: var(--panel-alt, #111827); border: 1px solid var(--border, #1f2937); border-radius: 4px; display: flex; flex-direction: column; min-height: 0; overflow-y: auto; }
    .col-header { display: flex; align-items: center; gap: 6px; padding: 8px 10px; border-bottom: 1px solid var(--border, #1f2937); font-size: 10px; text-transform: uppercase; letter-spacing: 0.3px; color: var(--muted, #9ca3af); font-weight: 600; flex-shrink: 0; }
    ...
    .field-item { display: flex; align-items: center; gap: 5px; padding: 6px 8px; margin: 2px 6px; background: var(--panel, #0f172a); border: 1px solid var(--border, #374151); border-left: 3px solid transparent; border-radius: 3px; cursor: pointer; }
    .field-item:hover { border-color: #58a6ff66; }
    .field-item.active { background: #1e3a5f33; border-color: #58a6ff; border-left-color: #58a6ff; }
    .field-item-handle { color: var(--muted, #6b7280); font-size: 12px; cursor: grab; }
    ...
    .field-item-sub { font-size: 9px; color: var(--muted, #9ca3af); }
    ...
    .preview-empty { padding: 40px; color: var(--muted, #9ca3af); font-style: italic; font-size: 12px; text-align: center; }
    ...
    .preview-label { font-size: 10px; color: var(--muted, #9ca3af); font-weight: 600; }
    .preview-label .req { color: #ef4444; margin-left: 2px; }
    .preview-form input, .preview-form select, .preview-form textarea { padding: 5px 8px; background: var(--panel-alt, #1f2937); border: 1px solid var(--border, #374151); color: var(--fg, #e5e7eb); border-radius: 2px; font-size: 11px; font-family: inherit; }
    ...
    .field-label { font-size: 9px; text-transform: uppercase; letter-spacing: 0.3px; color: var(--muted, #9ca3af); font-weight: 600; }
    .field input, .field select { padding: 4px 6px; background: var(--panel, #0f172a); border: 1px solid var(--border, #374151); color: var(--fg, #e5e7eb); border-radius: 2px; font-size: 11px; font-family: inherit; }
    .field-row { display: flex; gap: 6px; align-items: center; }
    .field-row.two { display: grid; grid-template-columns: 1fr 1fr; }
    .check { display: flex; align-items: center; gap: 5px; font-size: 11px; color: var(--fg, #e5e7eb); cursor: pointer; }
    .check input { width: 13px; height: 13px; }

    .actions-editor { margin-top: 6px; display: flex; flex-direction: column; gap: 6px; }
    .act-phase { background: #0b1120; border: 1px solid var(--border, #1f2937); border-radius: 3px; padding: 6px; }
    ...
    .act-count { background: #1f2937; padding: 0 5px; border-radius: 8px; font-size: 8px; color: var(--muted, #9ca3af); }
    .act-row { display: grid; grid-template-columns: 80px 1fr 22px; gap: 2px; margin-bottom: 2px; }
    .act-row select, .act-row input { padding: 2px 4px; background: var(--panel, #0f172a); border: 1px solid var(--border, #374151); color: var(--fg, #e5e7eb); border-radius: 2px; font-size: 9px; font-family: ui-monospace, SFMono-Regular, Menlo, monospace; }
