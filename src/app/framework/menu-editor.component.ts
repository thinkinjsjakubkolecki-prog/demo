...
@EchelonWidget({
  ...
  styles: [`
    ...
    .wrap { background: var(--ech-panel, #0f172a); border-radius: 6px; border: 1px solid var(--ech-border, #1f2937); }
    .bar { display: flex; align-items: center; justify-content: space-between; padding: 12px 16px; border-bottom: 1px solid var(--ech-border, #1f2937); }
    ...
    .tree-header, .side-header { font-size: 10px; text-transform: uppercase; letter-spacing: 0.5px; color: var(--ech-muted, #9ca3af); padding: 0 4px 8px; font-weight: 600; }
