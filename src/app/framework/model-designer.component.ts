...
@EchelonWidget({
  ...
  styles: [`
    ...
    .model-line-2 { font-size: 10px; color: var(--ech-muted, #6b7280); }

    .detail { padding: 16px; overflow-y: auto; display: flex; flex-direction: column; gap: 14px; }
    .detail-header { display: flex; align-items: flex-start; justify-content: space-between; padding-bottom: 10px; border-bottom: 1px solid var(--ech-border, #1f2937); }
    ...
    .relations-section { background: var(--ech-panel-alt, #111827); border: 1px solid var(--ech-accent)33; border-radius: 4px; padding: 10px; }
    .rel-header { font-size: 10px; text-transform: uppercase; letter-spacing: 0.3px; color: var(--ech-accent); font-weight: 600; margin-bottom: 6px; }
    .rel-row { display: flex; align-items: center; gap: 6px; padding: 4px 8px; background: var(--ech-bg); border-radius: 3px; font-size: 11px; font-family: var(--ech-font-mono); margin-bottom: 2px; }
    .rel-this { color: var(--ech-accent); font-weight: 600; }
    .rel-target { color: var(--ech-accent); }
    .rel-arrow { color: var(--ech-muted, #6b7280); }
    .rel-kind { margin-left: auto; font-size: 9px; color: var(--ech-muted, #9ca3af); background: var(--ech-panel-alt); padding: 1px 5px; border-radius: 2px; }

    .fields-section { background: var(--ech-panel-alt, #111827); border: 1px solid var(--ech-border, #1f2937); border-radius: 4px; padding: 10px; }
    .fields-header { display: flex; align-items: center; gap: 6px; font-size: 10px; text-transform: uppercase; letter-spacing: 0.3px; color: var(--ech-muted, #9ca3af); font-weight: 600; margin-bottom: 8px; }
    ...
    .cell-i18n { font-size: 8px; font-family: var(--ech-font-mono); color: var(--ech-muted, #6b7280); overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }
    .cell-i18n.missing { color: var(--ech-danger); }
    .i18n-ok { color: var(--ech-success); font-size: 10px; margin-left: 2px; }
    ...
    .enum-input { width: 100%; padding: 3px 5px; background: var(--ech-panel, #0f172a); border: 1px solid var(--ech-border, #374151); color: var(--ech-success); border-radius: 2px; font-size: 10px; font-family: var(--ech-font-mono); }
    .no-ref { color: var(--ech-muted, #4b5563); font-size: 10px; }
    .item-type-select { width: 90px; padding: 2px 4px; background: var(--ech-panel, #0f172a); border: 1px solid var(--ech-border, #374151); color: var(--ech-success); border-radius: 2px; font-size: 9px; font-family: var(--ech-font-mono); }
    .ft-row input[type=text], .ft-row select { padding: 3px 5px; background: var(--ech-panel, #0f172a); border: 1px solid var(--ech-border, #374151); color: var(--ech-fg, #e5e7eb); border-radius: 2px; font-size: 10px; font-family: var(--ech-font-mono); }
    .ft-row input[type=checkbox] { width: 14px; height: 14px; justify-self: center; }
    .ft-actions { display: flex; gap: 2px; }

    .schema-preview { background: var(--ech-panel-alt, #111827); border: 1px solid var(--ech-border, #1f2937); border-radius: 4px; padding: 10px; }
    .sp-header { font-size: 10px; text-transform: uppercase; letter-spacing: 0.3px; color: var(--ech-muted, #9ca3af); font-weight: 600; margin-bottom: 6px; }
    .sp-code { margin: 0; padding: 10px; background: var(--ech-bg); border-radius: 3px; font-size: 11px; color: #d1d5db; font-family: var(--ech-font-mono); white-space: pre; overflow-x: auto; }

    .usage-section { background: var(--ech-panel-alt, #111827); border: 1px solid var(--ech-border, #1f2937); border-radius: 4px; padding: 10px; }
    .usage-header { font-size: 10px; text-transform: uppercase; letter-spacing: 0.3px; color: var(--ech-muted, #9ca3af); font-weight: 600; margin-bottom: 6px; }
    .usage-row { display: flex; align-items: center; gap: 6px; padding: 4px 8px; background: var(--ech-bg); border-radius: 3px; font-size: 11px; margin-bottom: 2px; }
    .usage-kind { font-size: 9px; color: var(--ech-muted, #9ca3af); background: var(--ech-panel-alt); padding: 1px 5px; border-radius: 2px; text-transform: uppercase; font-weight: 600; min-width: 30px; text-align: center; }
    .usage-id { font-family: var(--ech-font-mono); color: var(--ech-accent); }
    .usage-ctx { color: var(--ech-muted, #6b7280); font-size: 10px; }
    .usage-empty { font-size: 11px; color: var(--ech-muted, #6b7280); font-style: italic; }
    ...
    .field-label { font-size: 10px; text-transform: uppercase; letter-spacing: 0.3px; color: var(--ech-muted, #9ca3af); font-weight: 600; }
    .field input { padding: 5px 8px; background: var(--ech-panel-alt, #1f2937); border: 1px solid var(--ech-border, #374151); color: var(--ech-fg, #e5e7eb); border-radius: 2px; font-size: 12px; font-family: inherit; }
