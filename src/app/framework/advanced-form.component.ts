...
@EchelonWidget({
  ...
  styles: [`
    ...
    .btn-submit { padding: 8px 20px; background: #1e3a5f; border: 1px solid #3b82f6; color: #e0f2fe; border-radius: 3px; cursor: pointer; font-family: inherit; font-size: 13px; }
